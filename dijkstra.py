...
def DijkstraAlgorithm(graph, s, t=-1):
    """Algoritmo di Dijkstra permette di calcolare quello che è
        l'ALBERO dei cammini minimi da un nodo s, detto nodo radice"""
    ...
    #Al termine avrò trovato il vettore pred e d (delle durate)
    if t != -1:
