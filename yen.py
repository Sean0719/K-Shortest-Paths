...
def YenAlgorithm(graph, s, t, K):
    """L'algoritmo di Yen è un algoritmo pensato per grafi orientati, pesanti e
    senza cicli di costo negativo per determinare i K cammini minimi tra un nodo
    sorgente s e un nodo destinazione t"""
    ...
    if path != None:
        ...
        while X and k<K-1:
            ...
            aux_graph, pi, pred = DijkstraAlgorithm(transpose(aux_graph, num_nodes), t)    #Pi è il vettore dei costi dell'albero dei cammini minimi con radice in t
